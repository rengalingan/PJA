  ...
  <script type="text/javascript">
    ...
    $(document).ready(function() {
      table = $('#table').DataTable({ 
        ...
        "ajax": {
            "url": "<?php echo site_url('inventory_ctrl/ajax_list')?>",
            "type": "POST"
        },
    ...
    function edit_inventory(id)
    {
      ...
      $.ajax({
        url : "<?php echo site_url('inventory_ctrl/ajax_edit/')?>/" + id,
        type: "GET",
        dataType: "JSON",
    ...
    function save()
    {
      ...
      if(save_method == 'add') 
      {
          url = "<?php echo site_url('inventory_ctrl/ajax_add')?>";
      }
      else
      {
        url = "<?php echo site_url('inventory_ctrl/ajax_update')?>";
      }
    ...
    function delete_inventory(id)
    {
      if(confirm('Are you sure delete this data?'))
      {
        // ajax delete data to database
          $.ajax({
            url : "<?php echo site_url('inventory_ctrl/ajax_delete')?>/"+id,
            type: "POST",
            dataType: "JSON",
            success: function(data)
            {
